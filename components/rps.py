...
class RockPaperScissor:
    def __init__(self, totalScore):
        ...
        self.pBG = pygame.Surface((380, 380))
        self.cBG = pygame.Surface((320, 380))

        self.cImgPosition = ( self.sWIDTH / 2 - 530 , 125)
        self.pImgPosition = ( self.sWIDTH / 2 + 220, 125)

        self.cBGPosition = ( self.sWIDTH / 2 - 550, 100)
        self.pBGPosition = ( self.sWIDTH / 2 + 200, 100)
    ...
    def draw_ui(self):
        ...
        self.screen.blit(cTitle, (self.sWIDTH / 2 - 500 , 5))

        pTitle = self.FONT.render("PLAYER", True, self.BLACK)
        self.screen.blit(pTitle, (self.sWIDTH / 2 + 300, 5))
        ...
        self.screen.blit(cScoreText, (self.sWIDTH // 2 - 450 , 50))
        pScoreText = self.FONT.render(str(self.pScore), True, self.BLACK)
        self.screen.blit(pScoreText, (self.sWIDTH // 2 + 350 , 50))
    ...
    def updateScores(self, winner=None ):
        ...
        # # print("ini score buat input = "+ str(self.pScore))
        return self.pScore
